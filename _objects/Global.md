...
- **require(path)**
  ...
  - **Parameters**
    - **path** _[string, required]_: relative path to javascript file in the iCloud Drive /Drafts/Library/Scripts" folder. For example, to load the script in the file "test.js" in the "iCloud Drive/Drafts/Resources/Scripts/Utilities/" folder, use the path parameter "Utilities/test.js".
